...
public class EntityParticle extends Entity implements IEntityAdditionalSpawnData {
    ...
    public void writeSpawnData(ByteBuf buffer) {
        buffer.writeInt(this.movementVector.intX());
        buffer.writeInt(this.movementVector.intY());
        buffer.writeInt(this.movementVector.intZ());
        buffer.writeInt(this.movementDirection.ordinal());
    }

    @Override
    public void readSpawnData(ByteBuf additionalData) {
        this.movementVector.x = additionalData.readInt();
        this.movementVector.y = additionalData.readInt();
        this.movementVector.z = additionalData.readInt();
        this.movementDirection = ForgeDirection.getOrientation(additionalData.readInt());
    }
    ...
    protected void entityInit() {
        ...
        if (this.updateTicket == null) {
            this.updateTicket = ForgeChunkManager.requestTicket(Quantum.getInstance(), this.worldObj, ForgeChunkManager.Type.ENTITY);
    ...
    public void onUpdate()
    {
        ...
        TileEntity t = this.worldObj.getTileEntity(this.movementVector.intX(), this.movementVector.intY(), this.movementVector.intZ());
    ...
    private double turn()
    {
        ...
        if (zuoBian.getBlock(this.worldObj) == Blocks.air)
        {
            this.movementDirection = zuoFangXiang;
        }
        else if (youBian.getBlock(this.worldObj) == Blocks.air)
        {
