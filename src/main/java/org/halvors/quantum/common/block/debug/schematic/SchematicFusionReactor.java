                    ...
                    if (magnitude <= radius) {
                        if (y == 0 || y == size) {
                            if (magnitude >= 1) {
                                ...
                                map.put(pos.add(0, yDeviation, 0), QuantumBlocks.blockElectromagnet.getDefaultState().withProperty(BlockStateElectromagnet.TYPE, BlockElectromagnet.EnumElectromagnet.GLASS));
                            }
