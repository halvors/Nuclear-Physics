...
public class BlockMachine extends BlockRotatable {
    ...
    public EnumBlockRenderType getRenderType(IBlockState state) {
        if (state.getValue(type).isCustomRendered()) {
    ...
    public enum EnumModelMachine implements IStringSerializable {
        ACCELERATOR("accelerator", TileAccelerator.class, false),
        CHEMICAL_EXTRACTOR("chemical_extractor", TileChemicalExtractor.class, true),
        GAS_CENTRIFUGE("gas_centrifuge", TileGasCentrifuge.class, true),
        NUCLEAR_BOILER("nuclear_boiler", TileNuclearBoiler.class, true),
        QUANTUM_ASSEMBLER("quantum_assembler", TileQuantumAssembler.class, true);

        private String name;
        private Class<? extends TileEntity> tileClass;
        private boolean customRendered;

        EnumModelMachine(String name, Class<? extends TileEntity> tileClass, boolean customRendered) {
            this.name = name;
