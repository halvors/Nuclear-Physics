 ...
 */
public class TileElectricTurbineXY extends TileElectrical implements IMultiBlockStructure<TileElectricTurbineXY>, ITileNetworkable, IBoilHandler {
    ...
    public TileElectricTurbineXY() {
        /*
        EnergyStorage energyStorage = new EnergyStorage((int) maxPower * 20);
        EnergyStorage energyStorage = new EnergyStorage(320000000, 128000);
        energyStorage.setEnergyStored(320000000);
