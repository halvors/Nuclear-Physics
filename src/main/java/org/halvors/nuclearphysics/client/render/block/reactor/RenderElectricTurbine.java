...
public class RenderElectricTurbine extends TileEntitySpecialRenderer<TileElectricTurbine> {
    ...
    private static final OBJModelContainer modelLarge = new OBJModelContainer(ResourceUtility.getResource(ResourceType.MODEL, "electric_turbine_large.obj"), Arrays.asList("Shape1", "Shape2", "Shape3", "Shape4", "Shape5", "Shape6", "Shape7", "Shape8", "Shape9", "Shape10", "Shape11", "Shape12", "Shape13",  "Shape14", "Shape15", "Shape16", "Shape17"));
    ...
    private static final OBJModelContainer modelSmall = new OBJModelContainer(ResourceUtility.getResource(ResourceType.MODEL, "electric_turbine_small.obj"), Arrays.asList("Axis", "Head", "Plug", "Support"));
