...
public class GuiCreativeBuilder extends GuiComponentScreen {
    ...
    public GuiCreativeBuilder(Block block, Position pos) {
        this.block = block;
        this.pos = pos;
    }
    ...
    public void initGui() {
        ...
        textFieldSize = new GuiTextField(fontRendererObj, (xSize / 2) - 40, (ySize / 2) - 30, 50, 12);
    ...
    protected void drawGuiScreenForegroundLayer(int mouseX, int mouseY) {
        ...
        ((GuiButton) buttonList.get(0)).displayString = LanguageUtility.transelate(BlockCreativeBuilder.getSchematic(mode).getName());
