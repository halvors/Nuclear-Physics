...
public abstract class RecipeResource {
    ...
    public static class ItemStackResource extends RecipeResource {
        ...
        public ItemStackResource(ItemStack itemStack, float chance) {
            super(chance);
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ItemStackResource) {
                return itemStack.isItemEqual(((ItemStackResource) obj).itemStack);
            }

            if (obj instanceof ItemStack) {
                return itemStack.isItemEqual((ItemStack) obj);
            }
    ...
    public static class OreDictResource extends RecipeResource {
        ...
        public OreDictResource(String name) {
            super();
    ...
    public static class FluidStackResource extends RecipeResource {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof FluidStack) && obj.equals(fluidStack);
        }
