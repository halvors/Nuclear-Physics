...
public class ConfigurationManager {
    ...
    public static void loadConfiguration(final Configuration configuration) {
        ...
        General.electricUnit = EnumElectricUnit.fromSymbol(configuration.get(Configuration.CATEGORY_GENERAL, "electricUnit", EnumElectricUnit.REDSTONE_FLUX.getSymbol(), null, EnumElectricUnit.getSymbols().toArray(new String[EnumElectricUnit.values().length])).getString());
