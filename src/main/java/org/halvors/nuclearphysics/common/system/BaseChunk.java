...
public class BaseChunk {
    ...
    public BaseChunk(final IBlockAccess world, final ChunkPos pos) {
        this.world = world;
        this.pos = pos;
    }

    public BaseChunk(final Chunk chunk) {
    ...
    public BaseLayer getLayer(int y) {
        ...
        if (layers.get(getIndex(y)) == null) {
            layers.add(getIndex(y), new BaseLayer(y));
        }
    ...
    public void writeToNBT(final NBTTagCompound tag) {
        ...
        for (final BaseLayer layer : layers) {
    ...
    public void readFromNBT(final NBTTagCompound tag) {
        ...
        for (int i = 0; i < list.tagCount(); i++) {
            ...
            final BaseLayer layer = new BaseLayer(y);
