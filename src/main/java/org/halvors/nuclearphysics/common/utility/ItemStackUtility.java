...
public class ItemStackUtility {
    public static List<ItemStack> split(ItemStack stack) {
        ...
        list.add(size(stack, split + remain));
        list.add(size(stack, split));
    ...
    public static ItemStack merge(ItemStack orig, ItemStack toAdd) {
        ...
        return ItemStackUtility.size(orig, Math.min(orig.getMaxStackSize(), orig.stackSize + toAdd.stackSize));
    }
    ...
    public static ItemStack getMergeReject(ItemStack orig, ItemStack toAdd) {
        ...
        if (newSize > orig.getMaxStackSize()) {
            return ItemStackUtility.size(orig, newSize - orig.getMaxStackSize());
        } else {
            return ItemStackUtility.size(orig, newSize);
        }
    }
