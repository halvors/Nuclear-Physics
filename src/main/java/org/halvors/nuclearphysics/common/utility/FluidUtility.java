...
public class FluidUtility {
    ...
    /*
    // Does all the work needed to fill or drain an item of fluid when a player clicks on the block.
    public static boolean playerActivatedFluidItem(World world, int x, int y, int z, EntityPlayer player, ItemStack itemStack, EnumFacing side) {
        final IFluidHandler fluidHandler = FluidUtil.getFluidHandler(world, x, y, z, side);
