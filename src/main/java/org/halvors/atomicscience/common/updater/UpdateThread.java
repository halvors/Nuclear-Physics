package org.halvors.atomicscience.common.updater;
    ...
    public void run() {
        try {
            ...
            if (isNewVersionAvailable) {
                org.halvors.electrometrics.AtomicScience.getLogger().info("An updated version of " + mod.getModName() + " is available: " + newModVersion + ".");
            ...
            if (isCriticalUpdate) {
                org.halvors.electrometrics.AtomicScience.getLogger().info("This update has been marked as CRITICAL and will ignore notification suppression.");
            }
            ...
            org.halvors.electrometrics.AtomicScience.getLogger().log(Level.WARN, AbstractLogger.CATCHING_MARKER, "Update check for " + mod.getModName() + " failed.", e);
        }
