...
public enum MachineType {
	...
	public TileEntityMachine getTileEntity() {
		try {
			...
			e.printStackTrace();
			org.halvors.electrometrics.AtomicScience.getLogger().error("Unable to indirectly create TileEntity.");
		}
	...
	public ItemStack getItemStack() {
		return new ItemStack(org.halvors.electrometrics.AtomicScience.blockMachine, 1, metadata);
	}
