package org.halvors.atomicscience.client.gui.configuration;
...
public class GuiConfiguration extends GuiConfig {
    ...
    public GuiConfiguration(GuiScreen parent) {
        ...
        titleLine2 = org.halvors.electrometrics.AtomicScience.getConfiguration().getConfigFile().getAbsolutePath();
    }
